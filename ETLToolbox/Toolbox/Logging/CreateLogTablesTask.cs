    ...
    public class CreateLogTablesTask : GenericTask, ITask {
        ...
        private void CreateTasks() {
            ...
            List<ITableColumn> lpColumns = new List<ITableColumn>() {
                ...
                new TableColumn("ProcessName","nvarchar(100)", allowNulls: false) { DefaultValue = "''" },
                new TableColumn("StartMessage","nvarchar(4000)", allowNulls: false)  { DefaultValue = "''" },
                new TableColumn("IsRunning","bit", allowNulls: false) { DefaultValue = "1" },
                new TableColumn("EndMessage","nvarchar(4000)", allowNulls: false)  { DefaultValue = "''" },
                new TableColumn("WasSuccessful","bit", allowNulls: false) { DefaultValue = "0" },
                new TableColumn("AbortMessage","nvarchar(4000)", allowNulls: false)  { DefaultValue = "''" },
